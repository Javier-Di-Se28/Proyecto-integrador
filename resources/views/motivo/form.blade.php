    ...
    @foreach($errors->all() as $error)
        ...
        <div class="columns">
          ...
          <div>
           <label for="tipo">Tipo: </label>   
            <input type="text" " style="background-color:white" class="form-control" name="tipo" value="{{ isset($motivo->tipo)?$motivo->tipo:''}}"
             id="tipo"></div>
           </div>
        ...
        <div class="column">
         <div class="form-group">
            ...
            <input type="text"  class="form-control" name="descripcion" value="{{ isset($motivo->descripcion)?$motivo->descripcion:''  }}" 
            id="descripcion"> </div>
            ...
            <input type="text" type="radio" class="form-control" name="urgencia" value="{{ isset($motivo->urgencia)?$motivo->descripcion:''}}" 
            id="descripcion"> </div>
            ...
            <a class="btn btn-info" href="{{ url('motivo/')}}">Regresar</a>
